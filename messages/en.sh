...
CCTG_MSG_CFG_USAGE="Usage: %s config <name> [show | edit | mode <mode|clear> | args <string> | snapshot <seconds|off> | width <cols|clear> | cwd <path> | token [--token-env VAR|--token-stdin]]\n"
...
# status
CCTG_MSG_STATUS_SUMMARY="Targets: %s total\n"
CCTG_MSG_STATUS_ALL_HINT="  (stopped & activity hidden — use -a/--all to show)\n"
CCTG_MSG_STATUS_ALL_SHOWN="  (showing all)\n"
...
CCTG_MSG_ERR_STATUS_UNKNOWN_FLAG="ERROR: unknown status flag: '%s' (valid: --json, -a/--all)\n"
...
CCTG_MSG_USAGE_STATUS="Usage: %s status [--json] [-a|--all]\n"
